...
const ABOUT_FEATURES = [
    ...
    { title: '🎨 Design & UX', color: '#64D2FF', items: ['Modern light theme optimized for productivity', 'Animated page transitions & responsive layout', 'Chat history persisted in local storage for the current session'] },
];
